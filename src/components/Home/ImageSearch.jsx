  ...
  return (
    <div className='w-[70vw] h-[70px] flex items-center justify-center'>
        <div className='w-[100%] mx-[30px] flex items-center justify-start relative top-0'>
            <select className='outline-none w-[20%] h-[40px] rounded-l indent-2 bg-zinc-200 dark:bg-zinc-500  dark:border-0 border-zinc-400 border-[1px] text-black font-[600] text-[18px]' value={searchBy} name="searchBy" id="searchBy" onChange={e=> setSearchBy(e.target.value)}>
